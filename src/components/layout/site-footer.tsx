  ...
  return (
    <footer className="bg-ink text-white">
      <div className="mx-auto grid max-w-6xl gap-12 px-5 py-16 md:grid-cols-3 md:px-8 md:py-20">
        ...
        <div>
          ...
          <address className="mt-4 not-italic text-sm leading-relaxed text-white/70">
            ...
            <a
              href={firm.phoneHref}
              className="mt-3 inline-block transition-colors hover:text-white"
            >
              {firm.phone}
            </a>
            <br />
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto flex max-w-6xl flex-col gap-2 px-5 py-6 text-xs text-white/40 md:flex-row md:items-center md:justify-between md:px-8">
          <p>
            © {year} {firm.name}. All rights reserved.
          </p>
          <p>Attorney advertising. This website does not create an attorney-client relationship.</p>
        </div>
      </div>
    </footer>
  );
